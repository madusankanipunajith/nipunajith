    ...
    return (
        <div className={`flex md:flex-row flex-col ${styles.paddingY}`}>
                    ...
                    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
                        ...
                        <div className="absolute z-[5] w-[40%] h-[35%] top-0 blur-2xl blue__gradient" />
                        <div className="absolute z-[1] w-[80%] h-[60%] rounded-full white__gradient bottom-40" />
                        <div className="absolute z-[0] w-[50%] h-[50%] right-20 bottom-20 blur-2xl" />
                    </div>
                </div>
    );
}
